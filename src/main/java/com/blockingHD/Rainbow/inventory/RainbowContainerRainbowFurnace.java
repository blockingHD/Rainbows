...
public class RainbowContainerRainbowFurnace extends Container{
    ...
    public RainbowContainerRainbowFurnace(InventoryPlayer player, TileEntityRainbowFurnace tileEntityFurnace) {
